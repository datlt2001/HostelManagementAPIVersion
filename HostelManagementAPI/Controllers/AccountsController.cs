...
namespace HostelManagementAPI.Controllers
{
    ...
    public class AccountsController : ControllerBase
    {
        ...
        [HttpPost("Login")]
        public async Task<IActionResult> Login([FromBody] Account accountLogin)
        {
            var result = await repository.GetLoginAccount(accountLogin.UserEmail, accountLogin.UserPassword);
